# The name of this view in Looker is "Youtube Playlist Items Test"
view: youtube_playlist_items_test {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `al_jazeera_data_models_poc.youtube_playlist_items_test`
    ;;
