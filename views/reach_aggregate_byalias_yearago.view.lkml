# The name of this view in Looker is "Reach Aggregate Byalias Yearago"
view: reach_aggregate_byalias_yearago {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ajmn-rs-bq.al_jazeera_data_models_poc.reach_aggregate_byalias_yearago`
    ;;
