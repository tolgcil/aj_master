# The name of this view in Looker is "Facebook Post Comments Temp"
view: facebook_post_comments_temp {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `al_jazeera_data_models_poc.facebook_post_comments_temp`
    ;;
  drill_fields: [id]
