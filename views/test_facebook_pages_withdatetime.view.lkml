# The name of this view in Looker is "Test Facebook Pages Withdatetime"
view: test_facebook_pages_withdatetime {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `al_jazeera_data_models_poc.TEST_facebook_pages_withdatetime`
    ;;
