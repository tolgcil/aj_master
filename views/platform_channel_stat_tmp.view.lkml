# The name of this view in Looker is "Platform Channel Stat Tmp"
view: platform_channel_stat_tmp {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `al_jazeera_data_models_poc.platform_channel_stat_tmp`
    ;;
